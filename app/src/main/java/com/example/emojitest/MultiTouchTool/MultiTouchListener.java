...
public class MultiTouchListener implements OnTouchListener {
    ...
    CreateIconActivity.OnSpiralTouch onSpiralTouch;
    private SelectionListener selectionListener;

    public MultiTouchListener setSelectionListener(SelectionListener selectionListener2) {
        this.selectionListener = selectionListener2;
        return this;
    }


    public void setOnSpiralTouch(CreateIconActivity.OnSpiralTouch onSpiralTouch) {
        this.onSpiralTouch = onSpiralTouch;
    }
    ...
    public boolean onTouch(View view, MotionEvent event) {
        if (this.selectionListener != null) {
            this.selectionListener.onTouch(view, event);
        }
        ...
        switch (action & event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                if (onSpiralTouch != null) {

                    this.onSpiralTouch.OnTouch(MotionEvent.ACTION_DOWN);
                }
                mPrevX = event.getX();
                mPrevY = event.getY();
                ...
                if (this.selectionListener != null) {
                    this.selectionListener.onDown(view);
                    break;
                }
            ...
            case MotionEvent.ACTION_UP:
                if (onSpiralTouch != null) {
                    ...
                    this.onSpiralTouch.OnTouch(MotionEvent.ACTION_UP);
                }
                mActivePointerId = INVALID_POINTER_ID;
                break;
