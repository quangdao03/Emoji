...
public class IconAdditionAdapter extends RecyclerView.Adapter<IconAdditionAdapter.ViewHolder> {
    Context context;
    ...
    public IconAdditionAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
