...
public class IconBreadAdapter extends RecyclerView.Adapter<IconBreadAdapter.ViewHolder> {
    Context context;
    ...
    public IconBreadAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
