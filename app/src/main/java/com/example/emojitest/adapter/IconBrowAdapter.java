...
public class IconBrowAdapter extends RecyclerView.Adapter<IconBrowAdapter.ViewHolder> {
    Context context;
    ...
    public IconBrowAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
