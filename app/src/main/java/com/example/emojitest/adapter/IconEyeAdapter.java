...
public class IconEyeAdapter extends RecyclerView.Adapter<IconEyeAdapter.ViewHolder> {
    Context context;
    ...
    public IconEyeAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
