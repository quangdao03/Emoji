...
public class IconGlassAdapter extends RecyclerView.Adapter<IconGlassAdapter.ViewHolder> {
    Context context;
    ...
    public IconGlassAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
