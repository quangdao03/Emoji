...
public class IconMouthAdapter extends RecyclerView.Adapter<IconMouthAdapter.ViewHolder> {
    Context context;
    ...
    public IconMouthAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
