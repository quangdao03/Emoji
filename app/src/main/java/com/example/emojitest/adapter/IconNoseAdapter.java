...
public class IconNoseAdapter extends RecyclerView.Adapter<IconNoseAdapter.ViewHolder> {
    Context context;
    ...
    public IconNoseAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
