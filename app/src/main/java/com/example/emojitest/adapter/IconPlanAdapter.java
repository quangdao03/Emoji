...
public class IconPlanAdapter extends RecyclerView.Adapter<IconPlanAdapter.ViewHolder> {
    Context context;
    ...
    public IconPlanAdapter(Context context, iClickListener iClickListener, int selectedPosition) {
