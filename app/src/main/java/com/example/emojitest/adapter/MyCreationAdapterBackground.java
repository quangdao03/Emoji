...
public class MyCreationAdapterBackground extends RecyclerView.Adapter<MyCreationAdapterBackground.ViewHolderMyCreation> {
    ...
    public MyCreationAdapterBackground(Context context, List<Uri> listImageSaved, OnClickImage onClickImage) {
